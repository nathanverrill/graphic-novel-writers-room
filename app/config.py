...
LIBRARY_DIR = ROOT / "library"         # the books' own material: library/<campaign>/<kind>/
...
LIBRARY_DIRS = (LIBRARY_DIR, SKILLS_DIR)
REFERENCES_DIR = LIBRARY_DIR           # the old name, while anything still says references
