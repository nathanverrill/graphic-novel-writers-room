"""Split the Evoke Prosperity campaign bible into a general bible and one file per chapter.
    ...
    python tools/split_bible.py [references/sources/EVOKE_PROSPERITY_CAMPAIGN_BIBLE.md]
...
def main(source):
    ...
    bible = ["<!-- generated by tools/split_bible.py from references/sources/"
    ...
    for n in sorted(chapters):
        c = chapters[n]
        doc = ["<!-- generated by tools/split_bible.py from references/sources/"
