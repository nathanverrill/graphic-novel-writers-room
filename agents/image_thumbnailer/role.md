...
For each panel with a `description` in the Penciller's layout blocks, the app asks the image
...
The quality of this preview depends on the Penciller's panel descriptions and the Character
