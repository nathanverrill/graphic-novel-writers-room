"""Split the Evoke Prosperity campaign bible into a general bible and one file per chapter.
    ...
    python agents/tools/split_bible.py [references/sources/EVOKE_PROSPERITY_CAMPAIGN_BIBLE.md]
...
SOURCE = ROOT / "references" / "sources" / "EVOKE_PROSPERITY_CAMPAIGN_BIBLE.md"
OUT = ROOT / "references"
...
def main(source):
    ...
    bible = ["<!-- generated by agents/tools/split_bible.py from references/sources/"
    ...
    for n in sorted(chapters):
        c = chapters[n]
        doc = ["<!-- generated by agents/tools/split_bible.py from references/sources/"
