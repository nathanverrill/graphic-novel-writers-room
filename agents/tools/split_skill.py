"""Split a long source skill into per-role guides, so each agent reads only the parts it needs.
    ...
    python agents/tools/split_skill.py
...
SOURCE = ROOT / "agents" / "skills" / "sources" / "story_to_visual_translation_skill.md"
...
HEADER = "<!-- generated by agents/tools/split_skill.py from agents/skills/sources/{source}; edit the source and rerun -->\n\n"
