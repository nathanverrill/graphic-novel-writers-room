...
SOURCE = ROOT / "agents" / "skills" / "originals" / "story_to_visual_translation_skill.md"
...
HEADER = "<!-- generated by scripts/split_skill.py from agents/skills/originals/{source}; edit the source and rerun -->\n\n"
